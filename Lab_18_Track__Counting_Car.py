...
while True:
    ...
    cv.line(contours_img,(0,y_startCount),(fwidth,y_startCount),(0,255,0),3)
    cv.line(contours_img,(0,y_endCount),(fwidth,y_endCount),(0,255,0),3)
    ...
    if(id_frame>100):
        ...
        #for TrackedBlob in TrackedBlob_Table:
         #   (TrackedBlob.color)
         #   TrackedBlob.color = (255,255,255)
